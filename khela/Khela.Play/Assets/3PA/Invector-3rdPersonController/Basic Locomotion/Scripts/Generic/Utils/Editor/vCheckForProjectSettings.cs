...
namespace Invector.vCharacterController
{
    ...
    public class vCheckForProjectSettings
    {
        ...
        {
            // Khela: Invector's onboarding nag disabled — we manage tags/layers + Active Input Handling
            // manually (see docs/INVECTOR_INPUT_MIGRATION.md); its checks (Player==layer 8, legacy axis
            // "LeftAnalogHorizontal") can never pass under our new-Input-only setup, so it nagged forever.
            // Original: return checkLayer != 8 || !IsAxisAvailable("LeftAnalogHorizontal");
            return false;
        }
