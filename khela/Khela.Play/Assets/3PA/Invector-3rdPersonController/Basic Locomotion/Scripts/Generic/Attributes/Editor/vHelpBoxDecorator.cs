...
{
    public Vector2 size;
    GUIStyle style; // NOTE: do NOT initialize from EditorStyles here — the ctor runs off-GUI (Search indexer) where EditorStyles is null → NRE. Lazily built in OnGUI/GetHeight.
