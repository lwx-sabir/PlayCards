...
namespace ChocDino.UIFX
{
	internal static class UnityShaderProp
	{
		...
		public readonly static int SrcBlend = Shader.PropertyToID("_SrcBlend");
		public readonly static int DstBlend = Shader.PropertyToID("_DstBlend");
		public readonly static int AlphaSrcBlend = Shader.PropertyToID("_AlphaSrcBlend");
		public readonly static int AlphaDstBlend = Shader.PropertyToID("_AlphaDstBlend");
		...
		{
			if (material.HasProperty(UnityShaderProp.Stencil))
			{
		...
		{
			if (src.HasProperty(UnityShaderProp.Stencil) && dst.HasProperty(UnityShaderProp.Stencil))
			{
