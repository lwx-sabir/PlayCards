...
namespace Sonity.PlayMaker {
    ...
    public class SonityGetLastPlayedClipTimeSeconds : SonityActionBase {
        [RequiredField]
        ...
        protected override void DoSoundEventAction() {
            storeTimeIn.Value = m_SoundEvent.GetLastPlayedClipTimeSeconds(m_Transform, pitchSpeed.Value);
        }
    }
}
#endif