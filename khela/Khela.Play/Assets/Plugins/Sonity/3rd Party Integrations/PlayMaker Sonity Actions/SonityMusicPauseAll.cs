...
namespace Sonity.PlayMaker {
    ...
    [Tooltip("Pauses all SoundEvents at the Music Transform locally")]
    public class SonityMusicPauseAll : SonitySoundManagerActionBase {
        ...
        protected override void DoSoundManagerAction() {
            m_SoundManager.MusicPauseAll(forcePause.Value);
        }
    }
}
#endif