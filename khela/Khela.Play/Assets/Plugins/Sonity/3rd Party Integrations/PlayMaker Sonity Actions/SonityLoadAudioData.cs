...
namespace Sonity.PlayMaker {
    ...
    [Tooltip("Loads the audio data of any AudioClips assigned to the SoundContainers of the SoundEvent")]
    public class SonityLoadAudioData : SonityActionBase {
