...
namespace Sonity.Internal {
    ...
    public static class EditorColor {
        ...
        // Purple
        private static Color soundTagColor = new Color(0.619f, 0f, 1f);
        public static Color GetSoundTag(float alpha) {
            Color outputColor = soundTagColor;
            outputColor.a = alpha;
            return outputColor;
        }
        ...
        // Lime green
        private static Color debugColor = new Color(0.375f, 1f, 0f);
        public static Color GetDebug(float alpha) {
            Color outputColor = debugColor;
            outputColor.a = alpha;
            return outputColor;
        }

        // Orange
        private static Color editorToolsColor = new Color(1f, 0.5f, 0f);
        public static Color GetEditorTools(float alpha) {
            Color outputColor = editorToolsColor;
            outputColor.a = alpha;
            return outputColor;
        }

        // Light Blue
        private static Color soundManagerStatisticsColor = new Color(0f, 0.964f, 1f);
        public static Color GetSoundManagerStatistics(float alpha) {
            Color outputColor = soundManagerStatisticsColor;
            outputColor.a = alpha;
            return outputColor;
        }
        ...
        // Grey
        private static Color sound3d2dMixedColor = new Color(0.5f, 0.5f, 0.5f);
        public static Color GetSound2d3dMixedColor(float alpha) {
            Color outputColor = sound3d2dMixedColor;
            outputColor.a = alpha;
            return outputColor;
        }

        // Orange
        private static Color sound3dColor = new Color(1f, 0.5f, 0f);
        public static Color GetSound3dColor(float alpha) {
            Color outputColor = sound3dColor;
            outputColor.a = alpha;
            return outputColor;
        }

        // Blue
        private static Color sound2dColor = new Color(0f, 1f, 1f);
        public static Color GetSound2dColor(float alpha) {
            Color outputColor = sound2dColor;
            outputColor.a = alpha;
            return outputColor;
        }

        // Pink
        private static Color sound2dDistand3dNoDistanceColor = new Color(1f, 0f, 1f);
        public static Color GetSound2dDistand3dNoDistanceColor(float alpha) {
            Color outputColor = sound2dDistand3dNoDistanceColor;
            outputColor.a = alpha;
            return outputColor;
        }
        ...
        // White
        private static Color physicsConditionsColor = new Color(1f, 1f, 1f);
        public static Color GetPhysicsConditionsColor(float alpha) {
            Color outputColor = physicsConditionsColor;
            outputColor.a = alpha;
            return outputColor;
        }

        // Yellow
        private static Color physicsColor = new Color(1f, 0.67f, 0.08f);
        public static Color GetPhysics(float alpha) {
            Color outputColor = physicsColor;
            outputColor.a = alpha;
            return outputColor;
        }

        // Purple
        private static Color presetColor = new Color(0.7f, 0.3f, 1f);
        public static Color GetPreset(float alpha) {
            Color outputColor = presetColor;
            outputColor.a = alpha;
            return outputColor;
        }
