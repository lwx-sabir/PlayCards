...
namespace Khela.Game.Migrations
{
    ...
    [Migration("20260823161134_AddVipPointsWindow")]
    partial class AddVipPointsWindow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Khela.Game.Database.Models.CurrencyExchange", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<decimal>("RateFromPerUnit")
                    ...
                    b.HasIndex("UserId", "PairKey", "CreatedAt");
            ...
            modelBuilder.Entity("Khela.Game.Database.Models.PlayerWallet", b =>
                {
                    ...
                    b.Property<decimal>("GiftedBalance")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");
            ...
            modelBuilder.Entity("Khela.Game.Database.Models.Report", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Khela.Game.Database.Models.Season", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Khela.Game.Database.Models.StoreEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Khela.Game.Database.Models.StorePurchase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("CatalogSnapshotJson")
                        .HasColumnType("longtext");

                    b.Property<string>("ClientPriceCurrency")
                        .HasMaxLength(8)
                        .HasColumnType("varchar(8)");

                    b.Property<long?>("ClientPriceMicros")
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("FulfilmentJson")
                        .HasColumnType("longtext");
                    ...
                    b.Property<string>("ObfuscatedAccountId")
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)");
                    ...
                    b.Property<decimal>("UsdReference")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");
                    ...
                    b.Property<string>("VerifierJson")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("Khela.Game.Database.Models.UserProfile", b =>
                {
                    ...
                    b.Property<DateTime?>("DailyXpResetAt")
                        .HasColumnType("datetime(6)");
                    ...
                    b.Property<long>("VipWindowPoints")
                        .HasColumnType("bigint");

                    b.Property<DateTime?>("VipWindowValidUntil")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("Khela.Game.Database.Models.WalletTransaction", b =>
                {
                    ...
                    b.Property<decimal?>("GiftedBalanceAfter")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");

                    b.Property<decimal?>("GiftedBalanceBefore")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");

                    b.Property<decimal>("GiftedDelta")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");
