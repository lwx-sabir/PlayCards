...
namespace Sonity.Internal {
    ...
    public static class SoundContainerCopy {
        ...
        public static void CopyTo(SoundContainerBase to, SoundContainerBase from, bool copyAudioClips = false) {
            ...
            to.internals.data.steamAudio.steamAudioExpand = false;
            ...
            to.internals.data.steamAudio.directBinaural = from.internals.data.steamAudio.directBinaural;
            to.internals.data.steamAudio.interpolation = from.internals.data.steamAudio.interpolation;
            to.internals.data.steamAudio.perspectiveCorrection = from.internals.data.steamAudio.perspectiveCorrection;

            to.internals.data.steamAudio.distanceAttenuation = from.internals.data.steamAudio.distanceAttenuation;
            to.internals.data.steamAudio.distanceAttenuationInput = from.internals.data.steamAudio.distanceAttenuationInput;
            to.internals.data.steamAudio.distanceAttenuationValue = from.internals.data.steamAudio.distanceAttenuationValue;
            to.internals.data.steamAudio.airAbsorption = from.internals.data.steamAudio.airAbsorption;
            to.internals.data.steamAudio.airAbsorptionInput = from.internals.data.steamAudio.airAbsorptionInput;
            to.internals.data.steamAudio.airAbsorptionLow = from.internals.data.steamAudio.airAbsorptionLow;
            to.internals.data.steamAudio.airAbsorptionMid = from.internals.data.steamAudio.airAbsorptionMid;
            to.internals.data.steamAudio.airAbsorptionHigh = from.internals.data.steamAudio.airAbsorptionHigh;

            to.internals.data.steamAudio.directivity = from.internals.data.steamAudio.directivity;
            to.internals.data.steamAudio.directivityInput = from.internals.data.steamAudio.directivityInput;
            to.internals.data.steamAudio.dipoleWeight = from.internals.data.steamAudio.dipoleWeight;
            to.internals.data.steamAudio.dipolePower = from.internals.data.steamAudio.dipolePower;
            to.internals.data.steamAudio.directivityValue = from.internals.data.steamAudio.directivityValue;

            to.internals.data.steamAudio.occlusion = from.internals.data.steamAudio.occlusion;
            to.internals.data.steamAudio.occlusionInput = from.internals.data.steamAudio.occlusionInput;
            to.internals.data.steamAudio.occlusionType = from.internals.data.steamAudio.occlusionType;
            to.internals.data.steamAudio.occlusionRadius = from.internals.data.steamAudio.occlusionRadius;
            to.internals.data.steamAudio.occlusionSamples = from.internals.data.steamAudio.occlusionSamples;
            to.internals.data.steamAudio.occlusionValue = from.internals.data.steamAudio.occlusionValue;
            to.internals.data.steamAudio.transmission = from.internals.data.steamAudio.transmission;
            to.internals.data.steamAudio.transmissionType = from.internals.data.steamAudio.transmissionType;
            to.internals.data.steamAudio.transmissionInput = from.internals.data.steamAudio.transmissionInput;
            to.internals.data.steamAudio.transmissionLow = from.internals.data.steamAudio.transmissionLow;
            to.internals.data.steamAudio.transmissionMid = from.internals.data.steamAudio.transmissionMid;
            to.internals.data.steamAudio.transmissionHigh = from.internals.data.steamAudio.transmissionHigh;
            to.internals.data.steamAudio.maxTransmissionSurfaces = from.internals.data.steamAudio.maxTransmissionSurfaces;

            to.internals.data.steamAudio.directMixLevel = from.internals.data.steamAudio.directMixLevel;

            to.internals.data.steamAudio.reflections = from.internals.data.steamAudio.reflections;
            to.internals.data.steamAudio.reflectionsType = from.internals.data.steamAudio.reflectionsType;
            to.internals.data.steamAudio.useDistanceCurveForReflections = from.internals.data.steamAudio.useDistanceCurveForReflections;
            // Class, dont copy by reference
            to.internals.data.steamAudio.currentBakedSource = new SteamAudio.SteamAudioBakedSource();
            to.internals.data.steamAudio.reflectionsIR = from.internals.data.steamAudio.reflectionsIR;
            to.internals.data.steamAudio.reverbTimeLow = from.internals.data.steamAudio.reverbTimeLow;
            to.internals.data.steamAudio.reverbTimeMid = from.internals.data.steamAudio.reverbTimeMid;
            to.internals.data.steamAudio.reverbTimeHigh = from.internals.data.steamAudio.reverbTimeHigh;
            to.internals.data.steamAudio.hybridReverbEQLow = from.internals.data.steamAudio.hybridReverbEQLow;
            to.internals.data.steamAudio.hybridReverbEQMid = from.internals.data.steamAudio.hybridReverbEQMid;
            to.internals.data.steamAudio.hybridReverbEQHigh = from.internals.data.steamAudio.hybridReverbEQHigh;
            to.internals.data.steamAudio.hybridReverbDelay = from.internals.data.steamAudio.hybridReverbDelay;
            to.internals.data.steamAudio.applyHRTFToReflections = from.internals.data.steamAudio.applyHRTFToReflections;
            to.internals.data.steamAudio.reflectionsMixLevel = from.internals.data.steamAudio.reflectionsMixLevel;

            to.internals.data.steamAudio.pathing = from.internals.data.steamAudio.pathing;
            // Class, dont copy by reference
            to.internals.data.steamAudio.pathingProbeBatch = new SteamAudio.SteamAudioProbeBatch();
            to.internals.data.steamAudio.pathValidation = from.internals.data.steamAudio.pathValidation;
            to.internals.data.steamAudio.findAlternatePaths = from.internals.data.steamAudio.findAlternatePaths;
            // Array, dont copy by reference
            to.internals.data.steamAudio.pathingEQ = new float[from.internals.data.steamAudio.pathingEQ.Length];
            for (int i = 0; i < to.internals.data.steamAudio.pathingEQ.Length; i++) {
                to.internals.data.steamAudio.pathingEQ[i] = from.internals.data.steamAudio.pathingEQ[i];
            }
            // Array, dont copy by reference
            to.internals.data.steamAudio.pathingSH = new float[from.internals.data.steamAudio.pathingSH.Length];
            for (int i = 0; i < to.internals.data.steamAudio.pathingSH.Length; i++) {
                to.internals.data.steamAudio.pathingSH[i] = from.internals.data.steamAudio.pathingSH[i];
            }
            to.internals.data.steamAudio.applyHRTFToPathing = from.internals.data.steamAudio.applyHRTFToPathing;
            to.internals.data.steamAudio.pathingMixLevel = from.internals.data.steamAudio.pathingMixLevel;
