...
namespace Sonity.Internal {
    ...
    public class EditorTextSoundPolyGroup {
        ...
        public static readonly string polyphonyLimitTooltip = $"The maximum number of {nameof(NameOf.SoundEvent)}s which can be played at the same time in this {nameof(NameOf.SoundPolyGroup)}." + EditorTrial.trialTooltip;
    }
}
#endif