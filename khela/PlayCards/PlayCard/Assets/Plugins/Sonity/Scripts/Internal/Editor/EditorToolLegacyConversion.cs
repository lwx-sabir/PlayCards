...
namespace Sonity.Internal {
    ...
    public static class EditorToolLegacyMusicAnd2D {

        [MenuItem("Tools/Sonity 🔊/Legacy/Add Scripting Define Symbol for Legacy Functions Music and 2D", false, 110)] // Sonity
        private static void AddScriptingDefineSymbolForLegacyFunctionsMusicAnd2D() {
            EditorScriptingDefineSymbols.LegacyFunctionsMusicAnd2DAddRemove(true);
        }
    }

    public static class EditorToolLegacyConversionConvertSoundEventVolumePolyphony {

        [MenuItem("Tools/Sonity 🔊/Legacy/Convert SoundEvent Modifier Volume and Polyphony to Base", false, 111)] // Sonity
    ...
    public static class EditorToolLegacyConversionApplySoundContainerAudioMixerGroupToSoundEvent {
        ...
        [MenuItem("Tools/Sonity 🔊/Legacy/Apply SoundContainer AudioMixerGroup to SoundEvent if None", false, 112)] // Sonity
        private static void ConvertSoundEventVolumePolyphony() {
            foreach (UnityEngine.Object objectInstance in Selection.objects) {
                SoundEventBase soundEvent = null;
                try {
