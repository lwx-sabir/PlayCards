...
namespace Sonity.Internal {
    ...
    public class EditorTextSoundPreset {
        ...
        public static readonly string soundPresetTooltip =
        ...
        public static readonly string disableAllLabel = $"Disable All";
        public static readonly string disableAllTooltip = $"If disabled no settings from the {nameof(NameOf.SoundPreset)} will be applied automatically and not available in the preset menus." + EditorTrial.trialTooltip;

        public static readonly string automaticLoopLabel = $"Automatic Loop";
        public static readonly string automaticLoopTooltip =
        ...
        public static readonly string disableLabel = $"Disable";
        public static readonly string disableTooltip = $"If disabled this specific preset won’t be available." + EditorTrial.trialTooltip;

        public static readonly string fromSoundContainerLabel = $"From SoundContainer";
        public static readonly string fromSoundContainerTooltip =
        ...
        public static readonly string fromSoundEventLabel = $"From SoundEvent";
        public static readonly string fromSoundEventTooltip =
        ...
        public static readonly string matchNameLabel = $"Auto Match";
        public static readonly string matchNameTooltip =
        ...
        public static readonly string applyOnAllLabel = $"Apply On All";
        public static readonly string applyOnAllTooltip =
        ...
        public static readonly string isPrefixLabel = $"Is Prefix";
        public static readonly string isPrefixTooltip =
        ...
        public static readonly string isNotPrefixLabel = $"Is Not Prefix";
        public static readonly string isNotPrefixTooltip = $"If the prefix of an asset doesn’t match the strings, the settings will be applied." + EditorTrial.trialTooltip;

        public static readonly string containsLabel = $"Contains";
        public static readonly string containsTooltip = $"If the name of an asset contains the strings, the settings will be applied." + EditorTrial.trialTooltip;

        public static readonly string notContainsLabel = $"Not Contains";
        public static readonly string notContainsTooltip = $"If the name of an asset doesn’t contain the strings, the settings will be applied." + EditorTrial.trialTooltip;
