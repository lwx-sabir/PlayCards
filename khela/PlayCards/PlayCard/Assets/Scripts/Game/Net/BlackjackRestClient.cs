...
namespace PlayCard.Game.Net
{
    ...
    public sealed class BlackjackRestClient
    {
        ...
        public Task<ApiResult<bool>> BetAsync(string tableId, decimal amount, int seatNumber, int handIndex = 0)
            => SendOkAsync(HttpMethod.Post, $"/api/Blackjack/{tableId}/bet",
        ...
        public Task<ApiResult<bool>> HitAsync(string tableId, int seatNumber, int handIndex = 0)
            => SendOkAsync(HttpMethod.Post, $"/api/Blackjack/{tableId}/hit/{seatNumber}?handIndex={handIndex}");

        public Task<ApiResult<bool>> StandAsync(string tableId, int seatNumber, int handIndex = 0)
            => SendOkAsync(HttpMethod.Post, $"/api/Blackjack/{tableId}/stand/{seatNumber}?handIndex={handIndex}");

        public Task<ApiResult<bool>> DoubleAsync(string tableId, int seatNumber, int handIndex = 0)
            => SendOkAsync(HttpMethod.Post, $"/api/Blackjack/{tableId}/double/{seatNumber}?handIndex={handIndex}");

        public Task<ApiResult<bool>> SplitAsync(string tableId, int seatNumber, int handIndex = 0)
            => SendOkAsync(HttpMethod.Post, $"/api/Blackjack/{tableId}/split/{seatNumber}?handIndex={handIndex}");

        public Task<ApiResult<bool>> InsuranceAsync(string tableId, int seatNumber, decimal amount, int handIndex = 0)
            => SendOkAsync(HttpMethod.Post, $"/api/Blackjack/{tableId}/insurance",
